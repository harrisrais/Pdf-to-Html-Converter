    ...
    public function handle(
        ...
        for ($i = 6; $i >= 0; $i--) {
            ...
            try {
                ...
                $pdfDocument = PdfDocument::firstOrCreate(
                    [
                ...
                if ($pdfDocument->wasRecentlyCreated) {
                    $this->info('PDF document record created.');
                } else {
                    $this->info('PDF document record already exists.');
                }
